...
public void setOutputFile(String inputFile) {
  ...
  void addFormula(WritableSheet sheet, int column, int row, String f)
	      throws RowsExceededException, WriteException {
	    Formula formula;
	    formula = new Formula(column, row, f);
  ...
  void addNumberFloat(WritableSheet sheet, int column, int row,
	      Float floating) throws WriteException, RowsExceededException {
	    Number number;
	    number = new Number(column, row, floating, times);
	    sheet.addCell(number);
	  }

  void addNumberDouble(WritableSheet sheet, int column, int row,
